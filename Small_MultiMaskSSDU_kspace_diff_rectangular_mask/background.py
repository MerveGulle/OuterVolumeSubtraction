...
full_data_path = "C:\\Codes\\p006_OVS\\OVS\\TestDatasetSmallNew"
ovs_data_path = "C:\\Codes\\p006_OVS\\OVS\\TestDatasetSmallCircularMask"
...
for sub in range(number_of_subjects):
    ...
    for slc in indices[1,sub][0]:
        ...
        for TF in range(5):
            ...
            filename = "C:\\Codes\\p006_OVS\\OVS\\TestDatasetSmallRectangularMask\\subject_" + str(indices[0,sub][0,0]) + "_slice_" + str(slc) + "_" + str(TF+1) + ".mat"
            ...
            filename = "C:\\Codes\\p006_OVS\\OVS\\Small_MultiMaskSSDU_kspace_diff_rectangular_mask\Results\\background004\\subject_"+str(subject_number)+"_slice_"+str(slc)+"_TF_"+str(time_frame_no)+".mat"
