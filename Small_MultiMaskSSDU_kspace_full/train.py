...
### PATHS 
# train_data_path = "C:\Codes\p006_OVS\OVS\Small_MultiMaskSSDU_kspace_full\TrainDatasetSmall"
train_data_path = "/home/naxos2-raid12/glle0001/TrainDatasetSmall/"
valid_data_path = "/home/naxos2-raid12/glle0001/ValidationDatasetSmall/"
test_data_path  = "/home/naxos2-raid12/glle0001/TestDatasetSmall/"
...
for epoch in range(params['num_epoch']):
    for i, (x0, composite_kspace, sense_map, acc_mask, data_consistency_masks, sub_slc_tf, index) in enumerate(train_loader['train_loader']):
        ...
        for k in range(params['num_mask']):
            ...
            xk0 = x0[0,2*k:2*k+2]   # x0 for kth DC mask
